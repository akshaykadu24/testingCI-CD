...
const Javascript = () => {
  ...
  const getData =(page)=>{
    let responce = axios.get(`https://api.github.com/search/repositories?q=stars:%3E1+language:javascript&per_page=10&page=${page}`)
    .then((res)=>{
  ...
  return (
    <Box>
      ...
      return  <Box border="1px solid red" >
          ...
          <Link to={`/javascript/${el.id}`}><Button >View detials</Button></Link>
