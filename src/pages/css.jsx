...
const Css = () => {
  ...
  const getData =(page)=>{
    let responce = axios.get(`https://api.github.com/search/repositories?q=stars:%3E1+language:css&per_page=10&page=${page}`)
    .then((res)=>{
  ...
  return (
    <Box>
      ...
      return  <Box border="1px solid red" >
          ...
          <Link to={`/css/${el.id}`}><Button >View detials</Button></Link>
